...
function generateContact(idContact = null, object = null) {
    let switchElement = '';
    if (index > 0) {
        switchElement = `<div class="col-sm-2 d-flex align-items-center">
                                                    <label class="switch">
    ...
    $('.contactBlocks').append(`
        ...
        style="border: solid 1px black; border-radius: 1%;" data-id="` + idContact + `">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control js-input" rows="3" id="address-ukr-` + index + `"
    ...
    /* FOR SETTING VALUES FROM SERVER*/
    if (object) {
...
saveContacts = function () {
    ...
    $("#contactBlocksId > div").each(function () {
        let title, address, coordinates, fileImage, imageName;
        $(this).find("input, textarea").each(function () {
            ...
            } else if ($(this).attr("id") === "logo-download-ukr-" + index) {
                imageName = document.getElementById("logo-download-ukr-" + index).src;
