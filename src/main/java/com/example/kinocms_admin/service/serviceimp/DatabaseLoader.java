...
public class DatabaseLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if(users.isEmpty()){
            ...
            User user2 = new User("andriy","fedorovych","n1oit","0666790166","programlearn2023@gmail.com","sarny","1111","-",LanguageCode.Ukr,true,LocalDate.of(2003,12,7),LocalDate.now(),false,"Костопільська 2");
            User user3 = new User("masha","melnyk","marka","0888123466","englandnew2023@gmail.com","rivne","2222","-",LanguageCode.Eng,false,LocalDate.of(2002,5,15),LocalDate.now(),false,"Шаршарова 2в");
            User user4 = new User("dasha","levina","povstanets","0985386941","dashaLevina@gmail.com","london","3333","-",LanguageCode.Eng,false,LocalDate.of(2004,3,2),LocalDate.now(),false,"Гетьман 2/1");
            User user5 = new User("rostyslave","dub","marsianin","0866785670","rost@gmail.com","dubai","4455","-",LanguageCode.Eng,true,LocalDate.of(2004,7,6),LocalDate.now(),false,"Дружня 22d");
            User user6 = new User("katya","gorodchuk","katyagorodchuk","0889765891","katka@gmail.com","kyiv","6554","-",LanguageCode.Eng,false,LocalDate.of(2004,7,6),LocalDate.now(),false,"Патріот 52");
            User user7 = new User("andriy","fedorovych","n1oit","0666790166","andrios@gmail.com","sarny","1111","-",LanguageCode.Ukr,true,LocalDate.of(2003,12,7),LocalDate.now(),false,"Костопільська 2");
            ...
            User user9 = new User("dasha","levina","povstanets","0985386941","dashaLevina@gmail.com","london","3333","-",LanguageCode.Eng,false,LocalDate.of(2004,3,2),LocalDate.now(),false,"Гетьман 2/1");
            User user10 = new User("rostyslave","dub","marsianin","0866785670","rost@gmail.com","dubai","4455","-",LanguageCode.Eng,true,LocalDate.of(2004,7,6),LocalDate.now(),false,"Дружня 22d");
